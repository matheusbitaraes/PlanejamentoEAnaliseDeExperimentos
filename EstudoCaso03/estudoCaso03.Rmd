...
Podemos perceber que a maioria dos blocos utilizou o orçamento máximo de execuçoes $n_{max}$, que era de 50 execuções. No entanto, a distribuição deste número de execuções é balanceada de uma forma que minimize o limite de precisão $se$.
