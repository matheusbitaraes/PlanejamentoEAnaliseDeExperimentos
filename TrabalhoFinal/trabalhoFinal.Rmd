...
colnames(data_sw) <- c("m30m80c300","m50m80c300","m80m80c300","m30m50c500","m50m50c500","m80m50c500","m30m50c800","m50m50c800","m80m50c800")
for (c in 1:9) {
  for (r in 1:100) {
...
y <- c(data_sw$m30m80c300, data_sw$m50m80c300,data_sw$m80c30, data_sw$m30m50c500,data_sw$m50c50, data_sw$m80c50,data_sw$m30m50c800, data_sw$m50c80,data_sw$m80c80)
group <- as.factor(c(rep(1, length(data_sw$m30m80c300)), rep(2, length(data_sw$m50m80c300)), rep(3, length(data_sw$m80c30)), rep(4, length(data_sw$m30m50c500)), rep(5, length(data_sw$m50c50)), rep(6, length(data_sw$m80c50)), rep(7, length(data_sw$m30m50c800)), rep(8, length(data_sw$m50c80)), rep(9, length(data_sw$m80c80))))
...
teste1 = nemenyi(teste,conf.level=0.95,plottype="mcb") # possiveis plots: "vline", "none", "mcb", "vmcb", "line", "matrix"
print(teste1$means)
summary(teste1)
```
