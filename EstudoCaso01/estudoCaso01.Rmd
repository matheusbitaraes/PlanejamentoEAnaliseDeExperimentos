...
Analisando o p-valor, podemos concluir que não há evidência estatistica forte o suficiente que indique que as variâncias não são iguais. Iremos portanto considerar homocedasticidade entre as subpopulações.
