...
Como pode ser visto, o resultado do teste de Wilcoxon retornou um p-valor igual a 0,07273, cujo valor é maior que o nível de significância adotado (0,05).
...
```{r, include=TRUE}
# Tamanho de efeito - ainda não implementado 
```

**Abordagem do Potência do Teste**

```{r, include=TRUE}
# Potênca do Teste - ainda não implementado 
```
