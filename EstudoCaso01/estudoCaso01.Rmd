...
Existem algumas maneiras de calcular a potência de um teste não paramétrico. Uma delas é a abordagem de Shieh \cite{Shieh2006}, que está dentro do pacote `wmwpow` do R \cite{wmwpow}. Esta abordagem utiliza simulações de Monte Carlo, com amostragens aleatórias massivas para determinar a potência. Este método requer uma definição da distribuição das amostras para o cálculo da potência. O que pode ser feito é verificar o teste para duas subpopulações de distribuição normal com o mesmo tamanho de amostras das subpopulações reais e mesmo tamanho de efeito. 

**Mesmo tamnho de amostras? no teste tá n=7 e m=4. Não entendi...**
